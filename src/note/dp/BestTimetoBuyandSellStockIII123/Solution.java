...
//    check how much maximum profit can be obtained for current day.
    ...
    // for example find the max profit of [1,5,3,6,4] at most at two transactions.
    ...
    public int maxProfit2(int[] prices) {
        ...
        // array forward keeps the max profit of the prefix array
        ...
        // array backward keeps the max profit of the suffix array
        ...
        int res = 0;
        // array forward represents the first transaction,
        // while array backward represents the second transaction.
        for (int k = 0; k < len; k++) {
